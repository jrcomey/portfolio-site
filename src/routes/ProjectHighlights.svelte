...
<section class="dark centered">
    ...
    <div class="big-project-title-page">
        ...
        <div class="big-project-description">
            <h3>MULTIROTOR GUST REDUCTION SYSTEM</h3>
            <p>
                As part of my undergraduate design project (see below), I worked with my team to 
                develop a system for the Blizzard eVTOL UAM aircraft to withstand both significant 
                gusts and other wind fields common to the Chicago area. I developed a fully fledged
                Guidance, Navigation, and Control system (GNC), using multiple controllers, to operate 
                the aircraft during flight. I developed optimal controllers using a Linear Quadratic 
                Regulator (LQR) from a linearized model, and demonstrated the controller using my 
                UAV simulation. I have currently performed dozens of tests to verify flight performance 
    ...
    <div class="big-project-title-page">
        ...
        <div class="big-project-description">
            <h3>ATP-XW BLIZZARD: WEATHER TOLERANT URBAN AIR MOBILITY CONCEPT</h3>
            <p>
