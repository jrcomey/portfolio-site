...
<section class="dark centered">
    ...
    <div class="big-project-title-page">
        ...
        <div class="project-image-backdrop-white">
            <img src=`${base}/assets/BlockDiagTransparent4.png` class="big-project-image-title-page" alt="MULTIROTOR GUST REDUCTION SYSTEM">
        </div>
        <div class="big-project-description">
            ...
            <p>
                To read more about it, <a href=`${base}/projects/grs`>click here</a>.
            </p>
        </div>
    </div>
    ...
    <div class="big-project-title-page">
        ...
        <div class="big-project-description">
            ...
            <p>
                To read more about it, <a href=`${base}/projects/blizzard`>click here</a>.
            </p>
        </div>
    </div>
