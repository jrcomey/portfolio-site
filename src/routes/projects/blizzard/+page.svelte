...
<section class="high-level-description">

    <h1>ALL WEATHER TAXI PILOTS EXPERIMENTAL WEATHER AIRCRAFT <i>BLIZZARD</i></h1>
...
<style>
    ...
    .gradient-background {
        ...
        width: 100%;
        height: 100%;
        background: linear-gradient(to top, rgba(15, 17, 18, 0.9), rgba(15, 17, 18, 0.9), 30%, rgba(15, 17, 18, 0));
        z-index: -1;
    }
